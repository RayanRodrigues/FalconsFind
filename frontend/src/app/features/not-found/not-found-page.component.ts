      ...
      <div class="relative mx-auto flex min-h-[calc(100vh-72px)] max-w-6xl items-center justify-center px-4 py-16 sm:px-6 lg:px-8">
        <div class="w-full text-center">
          <div class="mx-auto flex w-fit items-center justify-center gap-2 sm:gap-5">
            ...
            <div class="not-found-search relative flex h-24 w-24 items-center justify-center sm:h-40 sm:w-40">
              <img
                src="/SVG/Icon1.svg"
                alt="FalconFind"
                class="not-found-search__icon relative h-20 w-auto sm:h-32"
              />
            </div>
            <span class="text-[92px] font-black leading-none tracking-[-0.09em] text-primary sm:text-[180px]">4</span>
          </div>
          ...
          <div class="mx-auto mt-8 flex max-w-3xl flex-col items-center text-center">
            ...
            <p class="mt-8 max-w-2xl text-base leading-8 text-[var(--color-text-secondary)] sm:text-xl">
            ...
            <div class="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <a
                routerLink="/"
                class="inline-flex items-center justify-center rounded-full bg-primary px-8 py-3.5 text-base font-semibold text-white shadow-sm transition-colors hover:bg-secondary sm:px-10"
              >
                Back Home
              </a>
              <a
                routerLink="/found-items"
                class="inline-flex items-center justify-center rounded-full border border-[var(--color-border)] bg-transparent px-8 py-3.5 text-base font-semibold text-[var(--color-text-primary)] transition-colors hover:border-primary hover:text-primary sm:px-10"
              >
                Browse Found Items
              </a>
            </div>
