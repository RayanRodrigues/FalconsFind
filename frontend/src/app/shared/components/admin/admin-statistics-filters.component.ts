    ...
    <div class="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-5 shadow-sm">
      <div class="flex flex-col gap-5">
        <div class="flex flex-col gap-2 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <p class="mb-2 text-xs font-semibold uppercase tracking-[0.18em] text-[var(--color-text-secondary)]">Analytics Filters</p>
            <p class="mb-0 text-sm text-[var(--color-text-secondary)]">
              Narrow the dataset to inspect operational volume, recovery progress, and concentration by category or location.
            </p>
          </div>

          <div class="rounded-full border border-[var(--color-border)] bg-[var(--color-surface-2)] px-3 py-1.5 text-xs font-medium text-[var(--color-text-secondary)]">
            @if (latestReportedAt) {
        ...
        <div class="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
          <div>
            <label class="mb-2 block text-xs font-semibold uppercase tracking-[0.14em] text-[var(--color-text-secondary)]">Date From</label>
            <input
              type="date"
              [ngModel]="dateFrom"
          ...
          <div>
            <label class="mb-2 block text-xs font-semibold uppercase tracking-[0.14em] text-[var(--color-text-secondary)]">Category</label>
            <select
          ...
          <div>
            <label class="mb-2 block text-xs font-semibold uppercase tracking-[0.14em] text-[var(--color-text-secondary)]">Location</label>
            <input
              type="text"
